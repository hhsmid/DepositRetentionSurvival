...
#%% Load the dataset
file_path = '/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/Sourced/Knab data/transaction_data.parquet'
...
file_paths = {
    'retail_1': '/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/Final data/sampled_ids/R1_censored_sampled_ids.xlsx',
    'retail_2': '/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/Final data/sampled_ids/R2_censored_sampled_ids.xlsx',
    'retail_3': '/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/Final data/sampled_ids/R3_censored_sampled_ids.xlsx',
    'business_1': '/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/Final data/sampled_ids/B1_censored_sampled_ids.xlsx',
    'business_2': '/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/Final data/sampled_ids/B2_censored_sampled_ids.xlsx',
    'business_3': '/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/Final data/sampled_ids/B3_censored_sampled_ids.xlsx'
}
...
base_dir = '/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/OOS customer segmented data/'

# Retail segments
retail_segment_1.to_parquet(f"{base_dir}oos_retail_segment_1.parquet")
retail_segment_2.to_parquet(f"{base_dir}oos_retail_segment_2.parquet")
retail_segment_3.to_parquet(f"{base_dir}oos_retail_segment_3.parquet")

# Business segments
business_segment_1.to_parquet(f"{base_dir}oos_business_segment_1.parquet")
business_segment_2.to_parquet(f"{base_dir}oos_business_segment_2.parquet")
business_segment_3.to_parquet(f"{base_dir}oos_business_segment_3.parquet")
