...
def clean_and_prepare_data(df):
    sampled_ids = df['id_rand'].drop_duplicates().sample(n=300, random_state=1)
...
if __name__ == '__main__':
    # File paths
    fp_transaction_data = '/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/Customer segmented data/retail_segment_3.parquet'
    ...
    chunks_covariates_merged_df.to_parquet('/Users/hhsmid/Desktop/Hugo EUR/09. Seminar Financial Case Studies/03. Data/Final data/retail_segment_3_surv_long.parquet')
